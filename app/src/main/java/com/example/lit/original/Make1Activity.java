...
public class Make1Activity extends AppCompatActivity {
    ...
    //imageViewのbackgroundになる画像の変数の宣言
    Bitmap img;
    ...
    Button directionButtonRight;
    Button directionButtonLeft;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        directionButtonRight = (Button)findViewById(R.id.directionButtonRight);
        directionButtonLeft = (Button)findViewById(R.id.directionButtonLeft);
        ...
        if(sBG == ""){
            layout.setBackgroundColor(Color.parseColor("#e3e3e3"));
        } else if(sBG != null){
        ...
        imageView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                directionButtonRight.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                ...
                directionButtonLeft.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ssb = (SpannableStringBuilder)rotationEditText.getText();
                        Degree = ssb.toString();
    ...
    public void background(View v) {
        Intent intentM1 = new Intent(this, BackGroundHActivity.class);
